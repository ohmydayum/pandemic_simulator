class Society{
    constructor(V_MAX, MAX_FORCE, DAYS_UNTIL_QUARANTINED, HYGIENE, COUNT, PERCENTAGE_INITIAL_SICKNESS, INITIAL_ZONE, PERCENTAGE_QUARANTINED, AGE_DISTRIBUTION, percentage_verified, is_tracing_on, percentage_traced) {
        this.V_MAX= V_MAX;
        ...
        this.percentage_traced = percentage_traced;
    }
}